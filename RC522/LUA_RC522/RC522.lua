--[[
0 [*]   GPIO16 D0           7   GPIO13 D7( RXD2 | HMOSI )
1       GPIO5  D1           8   GPIO15 D8( TXD2 | HCS) 
2       GPIO4  D2           9   GPIO3  D9(RX0)
3       GPIO0  D3(flash)    10  GPIO1  D10(TXD)
4       GPIO2  D4(TXD1)     11  GPIO9  SD2
5       GPIO14 D5(HSCLK)    12  GPIO10 SD3
6       GPIO12 D6(HMISO)
]]
...
pin_rst = 2                 -- Enable/reset pin
pin_ss = 1                  -- SS (marked as SDA) pin
